        ...
        <div className="row">
          ...
          <div className="blog-blockt-two col-lg-6 col-md-6 col-sm-12">
            <div className="inner-box wow fadeInUp">
              ...
              <div className="text">
                {t(
                  "Fast and easy booking of reliable vehicles at great prices."
                )}
              </div>
              <Link href={`/cars`} className="read-more">
                {t("View vehicles")}
          ...
          <div className="blog-blockt-two col-lg-6 col-md-6 col-sm-12">
            <div className="inner-box two wow fadeInUp" data-wow-delay="100ms">
              ...
              <div className="text"> 
                {t(
                  "Pick up your vehicle quickly and without hassle – in the city or at the airport."
                )}
              </div>
